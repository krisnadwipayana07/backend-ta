...
type Usecase interface {
	...
	GetDataOLTP(ctx context.Context, id uint) (Domain, error)
	...
	GetPageVisitGraphOLTP(ctx context.Context, startDate time.Time, endDate time.Time) ([]string, []int32, error)
